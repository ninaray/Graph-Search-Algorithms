...
public class GraphAdjMatrix extends Graph {
	...
	public List<Integer> getDistance2(int v) {
		List<Integer> firstneighbors = this.getNeighbors(v);
		 List<Integer> secondneighbors = new ArrayList<Integer>();
		 for (Integer n: firstneighbors) {
			 for (Integer i: this.getNeighbors(n)) {
